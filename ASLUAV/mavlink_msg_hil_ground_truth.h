...
typedef struct __mavlink_hil_ground_truth_t {
 ...
 float roll_rate; /*< [rad/s] Roll rate*/
 float pitch_rate; /*< [rad/s] Pitch rate*/
 float yaw_rate; /*< [rad/s] Yaw rate*/
 int32_t lat; /*< [degE7] Latitude*/
 int32_t lon; /*< [degE7] Longitude*/
 float alt; /*<  Altitude*/
 float vn; /*< [m/s] Northing ground speed*/
 float ve; /*< [m/s] Easting ground speed*/
 float vd; /*< [m/s] Down ground speed*/
 float ias; /*< [m/s] Indicated airspeed*/
 float tas; /*< [m/s] True airspeed*/
 float wind_speed; /*< [m/s] Wind speed (2D)*/
 float wind_dir; /*< [deg] Wind direction (2D)*/
 float wind_z; /*< [m/s] Wind Z*/
 float alpha; /*< [deg] Angle of attack*/
 float beta; /*< [deg] Sideslip*/
}) mavlink_hil_ground_truth_t;

#define MAVLINK_MSG_ID_HIL_GROUND_TRUTH_LEN 84
#define MAVLINK_MSG_ID_HIL_GROUND_TRUTH_MIN_LEN 84
#define MAVLINK_MSG_ID_214_LEN 84
#define MAVLINK_MSG_ID_214_MIN_LEN 84

#define MAVLINK_MSG_ID_HIL_GROUND_TRUTH_CRC 61
#define MAVLINK_MSG_ID_214_CRC 61
...
#define MAVLINK_MESSAGE_INFO_HIL_GROUND_TRUTH { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_ground_truth_t, timestamp) }, \
         ...
         { "wind_z", NULL, MAVLINK_TYPE_FLOAT, 0, 72, offsetof(mavlink_hil_ground_truth_t, wind_z) }, \
         { "alpha", NULL, MAVLINK_TYPE_FLOAT, 0, 76, offsetof(mavlink_hil_ground_truth_t, alpha) }, \
         { "beta", NULL, MAVLINK_TYPE_FLOAT, 0, 80, offsetof(mavlink_hil_ground_truth_t, beta) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_GROUND_TRUTH { \
 ...
 * @param roll_rate [rad/s] Roll rate
 * @param pitch_rate [rad/s] Pitch rate
 * @param yaw_rate [rad/s] Yaw rate
 * @param lat [degE7] Latitude
 * @param lon [degE7] Longitude
 * @param alt  Altitude
 * @param vn [m/s] Northing ground speed
 * @param ve [m/s] Easting ground speed
 * @param vd [m/s] Down ground speed
 * @param ias [m/s] Indicated airspeed
 * @param tas [m/s] True airspeed
 * @param wind_speed [m/s] Wind speed (2D)
 * @param wind_dir [deg] Wind direction (2D)
 * @param wind_z [m/s] Wind Z
 * @param alpha [deg] Angle of attack
 * @param beta [deg] Sideslip
...
static inline uint16_t mavlink_msg_hil_ground_truth_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, float roll, float pitch, float yaw, float roll_rate, float pitch_rate, float yaw_rate, int32_t lat, int32_t lon, float alt, float vn, float ve, float vd, float ias, float tas, float wind_speed, float wind_dir, float wind_z, float alpha, float beta)
{
    ...
    _mav_put_float(buf, 72, wind_z);
    _mav_put_float(buf, 76, alpha);
    _mav_put_float(buf, 80, beta);
...
static inline void mavlink_msg_hil_ground_truth_send(mavlink_channel_t chan, uint64_t timestamp, float roll, float pitch, float yaw, float roll_rate, float pitch_rate, float yaw_rate, int32_t lat, int32_t lon, float alt, float vn, float ve, float vd, float ias, float tas, float wind_speed, float wind_dir, float wind_z, float alpha, float beta)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_HIL_GROUND_TRUTH_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
 ...
 *
 * @return [m/s] Northing ground speed
 */
 ...
 *
 * @return [m/s] Easting ground speed
 */
...
/**
 * @brief Get field wind_z from hil_ground_truth message
 *
 * @return [m/s] Wind Z
 */
static inline float mavlink_msg_hil_ground_truth_get_wind_z(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  72);
}

/**
 * @brief Get field alpha from hil_ground_truth message
 *
 * @return [deg] Angle of attack
 */
static inline float mavlink_msg_hil_ground_truth_get_alpha(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  76);
}

/**
 * @brief Get field beta from hil_ground_truth message
 *
 * @return [deg] Sideslip
 */
static inline float mavlink_msg_hil_ground_truth_get_beta(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_hil_ground_truth_decode(const mavlink_message_t* msg, mavlink_hil_ground_truth_t* hil_ground_truth)
{
    ...
    hil_ground_truth->wind_z = mavlink_msg_hil_ground_truth_get_wind_z(msg);
    hil_ground_truth->alpha = mavlink_msg_hil_ground_truth_get_alpha(msg);
    hil_ground_truth->beta = mavlink_msg_hil_ground_truth_get_beta(msg);
#else
